...
export default class ProductFilter extends Component {
    ...
    palleteDisplayChange = ()=> {
        this.setState({palleteDisplay : this.state.palleteDisplay ==="hidden" ? "productFilterPallete" : "hidden"})
    }  
                    ...
                    <section className ="palleteColorWrapper">
                        ...
                        <div>
                            <ul>
                                ...
                                <li 
                                className = {active ? 'colorListToggle':'colorListToggleWhite'}
                                name ={name} 
                                key={name} 
